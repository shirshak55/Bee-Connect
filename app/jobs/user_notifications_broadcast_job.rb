...
class UserNotificationsBroadcastJob < ApplicationJob
  ...
  def perform(notification)
    ...
    # ActionCable.server.broadcast "user_notifications_#{notification.recipient_id}_channel",
    # notification_type:notification.notifiable_type.underscore.pluralize,
    # template: render_notifications(notification)
  end
